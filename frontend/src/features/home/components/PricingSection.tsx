...
const PricingSection = () => {
  ...
  return (
    <section id="pricing" className="bg-[#f4f4f4] mx-auto py-14 px-40">
      ...
      <div className="flex flex-col md:flex-row gap-8 items-stretch">
        {plans &&
          plans.map((plan, idx) => (
            <div
              key={idx}
              className={`relative flex flex-col flex-1 bg-white border border-gray-200 shadow-md rounded-lg p-8`}
            >
              {plan.popular && (
